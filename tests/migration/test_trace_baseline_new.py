...
TARGET_PATHS = {
    "video_url_summary_001": [
        ...
        "application.chat.executors.fast_lanes.video_fast_impl:run_video_fast_path",
    ...
    "small_doc_summary_001": [
        "application.ingress.runtime:route_chat_request",
        "application.chat.executors.fast_lanes.document_fast_impl:run_document_fast_path",
    ...
    "web_read_001": [
        "application.ingress.runtime:route_chat_request",
        "application.chat.executors.fast_lanes.web_fast_impl:run_web_fast_path",
        "services.capabilities.web.web_orchestration_service:fetch_web_evidence_block",
    ],
    "kb_query_simple_001": [
        "application.ingress.runtime:route_chat_request",
        "application.chat.executors.fast_lanes.kb_fast_impl:run_kb_fast_path",
        "services.capabilities.knowledge.kb_pipeline:fetch_kb_answer_material",
    ],
    "multi_source_complex_001": [
        "application.ingress.runtime:route_chat_request",
        "application.chat.run_chat_turn:run_agno_chat_turn_impl",
        "application.chat.executors.complex.complex_path_impl:run_multisource_round0_answer",
        "application.chat.delivery_gate_flow:run_delivery_gate",
        "application.chat.executors.complex.complex_path_impl:run_feedback_round_execution",
    ],
}
